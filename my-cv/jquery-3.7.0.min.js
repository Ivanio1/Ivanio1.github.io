...
var arrLang = {
    'en': {
        ...
        'about me': 'about me',
        'paragraph': 'Software engineer with a proven ability to adapt in both self-starting and collaborative environments while staying focused on achieving high quality results under strict deadline. My strengths are flexibility, responsibility and decency. When I\'m not coding, you\'ll find me in the gym or on the court shooting hoops.',
        'contact': 'Contact',
        'city': 'Saint Petersburg, Russia',
        'follow':'Follow',
        'se':'Software engineering',
        'uni':'ITMO University, Russia',
        'time':'2021 - present',
        'ps':'Programming skills',
        'lang':'Language',
        'framtech':'Frameworks and technologies',
    ...
    'ru': {
        ...
        'about me': 'обо мне',
        'paragraph': 'Инженер-программист со способностью адаптироваться как к самостоятельной разработке, так и к совместной работе, оставаясь сосредоточенным на достижении высококачественных результатов в сжатые сроки. Мои сильные стороны - гибкость, ответственность и порядочность. Когда я не занимаюсь программированием, вы можете найти меня в спортзале или на баскетбольной площадке.',
        'contact': 'Контактные данные',
        'city': 'Санкт-Петербург, Россия',
        'follow':'Другие аккаунты',
        'se':'Программная инженерия',
        'uni':'Университет ИТМО, Россия',
        'time':'2021-Настоящее время',
        'ps':'Навыки программирования',
        'lang':'Язык    ',
        'framtech':'Фреймворки и технологии',
        'langs':'Другое',
        'diplom':'Дипломы',
        'mp':'Основные проекты',
        'op':'Другие проекты'
